...
<html lang="es">
   ...
   <body>
    ...
    <div class="place-container">
        <img src="images/home-slide-1.jpg" alt="Imagen del Lugar" class="place-image">
        <div class="place-description">
            <h2>Nombre del Lugar</h2>
            <p>Descripción del lugar. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac justo vel odio aliquam tincidunt.</p>
            <div class="place-rating">
                <span>Valoración:</span>
                <span>⭐⭐⭐⭐⭐</span>
            </div>
            <div class="place-buttons">
                <a href="#" class="btn">Comentarios</a>
