...
<html lang="es">
   <head>
      ...
      <title>Cinemex Mundo Divertido | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/cinedivertido1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/cinedivertido2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Cinemex Mundo Divertido</h3>
            <p>Descubre el mundo del entretenimiento en Cinemex Mundo Divertido.
            Este cine combina lo mejor de la pantalla grande con una variedad de actividades emocionantes para 
            garantizar un día lleno de diversión para toda la familia. Desde los últimos
            estrenos hasta clásicos favoritos, Cinemex Mundo Divertido ofrece una amplia
            selección de películas para todos los gustos. Además, cuenta con comodidades 
            modernas como asientos reclinables y una amplia oferta gastronómica.</p>
            ...
            <p>• Instalaciones accesibles para personas con discapacidad, incluyendo rampas y espacios reservados.</p>
            <h3>Actividades</h3>
            <p>• Amplia variedad de entretenimiento, como juegos interactivos, realidad virtual y eventos temáticos.</p>
            <h3>Servicios</h3>
            <p>• Amplia oferta gastronómica, desde snacks hasta platillos gourmet. <br> • Servicios premium como 
            asientos reclinables y salas VIP.</p>
            <h3>Niños</h3>
            <p>• Áreas de juego infantiles temáticas y actividades especiales para los más pequeños.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/hiry9NPsn6n3kRbV7" class="btn">Ubicación</a>
