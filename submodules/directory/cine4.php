...
<html lang="es">
   <head>
      ...
      <title>Cinemex Macroplaza | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/cinemexmacro1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/cinemexmacro2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Cinemex Macroplaza</h3>
            <p>Situado en el popular centro comercial Macroplaza, Cinemex Macroplaza es 
               el lugar ideal para disfrutar de las últimas películas en un
               ambiente cómodo y moderno. Con múltiples salas de proyección,
               tecnología de punta y una amplia selección de películas, este 
               cine ofrece algo para todos los gustos. Además, sus servicios 
               premium y opciones gastronómicas hacen que la experiencia sea aún más especial.</p>
      ...
      <a href="https://maps.app.goo.gl/ZnBktYjfwoLJtRw16" class="btn">Ubicación</a>
