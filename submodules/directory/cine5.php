...
<html lang="es">
   <head>
      ...
      <title>Cinemex Loma Bonita | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/cinemexloma1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/cinemexloma2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Cinemex Loma Bonita</h3>
            <p>Cinemex Loma Bonita es uno de los destinos preferidos para 
               los amantes del cine en Tijuana. Con sus cómodas instalaciones 
               y tecnología de vanguardia, este cine ofrece una experiencia única para
                disfrutar de las últimas películas en pantalla grande. 
                Además de proyecciones regulares, Cinemex Loma Bonita también 
                organiza eventos especiales y funciones en 3D para satisfacer las preferencias de todos los cinéfilos.</p>
            ...
            <h3>Servicios</h3>
            <p>• Restaurante <br> • Dulceria <br> • Boletos en línea.</p>
            <h3>Niños</h3>
            <p>• Ideal para ir con niños <br> • Películas infantiles.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/54U3wV33XfNVT1r97" class="btn">Ubicación</a>
