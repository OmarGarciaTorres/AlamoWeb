...
<html lang="es">
   <head>
      ...
      <title>Cinepolis Plaza Rio | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/cinemexrio1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/cinemexrio2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Cinepolis Plaza Rio</h3>
            <p>Situado en el conocido centro comercial Plaza Rio, Cinepolis Plaza Rio es un destino popular para los amantes del cine en Tijuana. Con múltiples salas de proyección equipadas con la última tecnología, este cine ofrece una experiencia visual impresionante para disfrutar de las últimas películas. Además, sus servicios premium, como asientos reclinables y opciones gastronómicas, garantizan una experiencia de cine completa y cómoda para todos los visitantes.</p>
            ...
            <p>• Estacionamiento accesible para personas en silla de ruedas</p>
            <h3>Actividades</h3>
            <p>• Proyecciones en 3D <br> 
            • Eventos especiales.</p>
            <h3>Servicios</h3>
            <p>• Restaurante <br> • Juegos de arcade</p>
            <h3>Niños</h3>
      ...
      <a href="https://maps.app.goo.gl/4BD2436ENVMaxGZDA" class="btn">Ubicación</a>
