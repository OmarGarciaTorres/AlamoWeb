...
<html lang="es">
   <head>
      ...
      <title>Cinemex Pacifico | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/cinemexpaci1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/cinemexpaci2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Cinemex Pacifico</h3>
            <p>Ubicado en el centro comercial Pacífico, este cine es una opción popular para disfrutar de las últimas películas en pantalla grande. Con proyecciones en 3D, eventos especiales y servicios premium como salas VIP y asientos cómodos, Cinemex Pacífico se esfuerza por brindar una experiencia cinematográfica memorable para sus visitantes. Además, su ambiente acogedor y oferta gastronómica diversa hacen que cada visita al cine sea una experiencia placentera.</p>
            ...
            <p>• Instalaciones accesibles y servicios para personas con discapacidad.<br> 
      ...
      <a href="https://maps.app.goo.gl/GQ62ukL9Aba6vqPM8" class="btn">Ubicación</a>
