...
<html lang="es">
   <head>
      ...
      <title>Hotel Frontiere | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/hotelfronti1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/hotelfronti2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Hotel Frontiere</h3>
            <p> Situado en una ubicación privilegiada en el centro de Tijuana, Hotel Frontiere es un oasis de tranquilidad y hospitalidad en medio del bullicio de la ciudad. Sus habitaciones están decoradas con un estilo tradicional mexicano y cuentan con comodidades modernas para garantizar una estancia confortable. El hotel ofrece una variedad de servicios, incluyendo un restaurante que sirve auténtica cocina mexicana, un bar acogedor, servicio de habitaciones las 24 horas y conexión Wi-Fi gratuita en todo el establecimiento. Además, cuenta con un personal amable y atento que está siempre dispuesto a ayudar y hacer que la estancia de los huéspedes sea lo más placentera posible. Con su encanto único y su ambiente acogedor, Hotel Frontiere ofrece una experiencia de alojamiento verdaderamente memorable en Tijuana.</p>
            ...
            <h3>Actividades</h3>
            <p>• Restaurante con cocina mexicana <br> 
            • Cocteleria y baristas profesionales.</p>
            <h3>Servicios</h3>
            <p>• Wi-Fi gratuito <br> • Bar <br> •  Servicio de lavandería </p>
            <h3>Niños</h3>
      ...
      <a href="https://maps.app.goo.gl/JVuk4t3iMx5Y2WVN8" class="btn">Ubicación</a>
