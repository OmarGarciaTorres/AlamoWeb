...
<html lang="es">
   <head>
      ...
      <title>Hotel Jardin | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/hoteljardin2.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/hoteljardin1.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Hotel Jardin</h3>
            <p>Ubicado en un entorno tranquilo y rodeado de hermosos jardines, Hotel Jardin es un refugio ideal para aquellos que buscan relajarse y desconectar del ajetreo de la vida diaria. Sus habitaciones están decoradas con un estilo encantador y ofrecen todas las comodidades necesarias para una estancia confortable. El hotel también cuenta con una piscina al aire libre, un restaurante que sirve cocina regional y un personal atento que garantiza una experiencia memorable para todos los huéspedes.</p>
            ...
            • Servicios adaptados para personas con movilidad reducida.</p>
            <h3>Actividades</h3>
            <p>• Tours guiados <br> 
            • Actividades al aire libre</p>
            <h3>Servicios</h3>
            <p>• Restaurante <br> • Wi-Fi gratis <br> • Piscina <br>
            • Servicio de habitaciones.</p>
            <h3>Niños</h3>
            <p>• Área de juegos <br> • Menú infantil.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/eUQiG81HAdKaSvdm8" class="btn">Ubicación</a>
