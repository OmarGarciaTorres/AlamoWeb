...
<html lang="es">
   <head>
      ...
      <title>Baja Inn La Mesa | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/hotelbaja1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/hotelbaja2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Baja Inn La Mesa</h3>
            <p>  Situado en el animado distrito de La Mesa, Baja Inn La Mesa es una opción asequible para aquellos que buscan un alojamiento sencillo pero cómodo en Tijuana. Sus habitaciones son funcionales y están equipadas con lo esencial para una estancia agradable, incluyendo camas cómodas, baño privado y televisión por cable. A pesar de su tarifa económica, el hotel ofrece servicios prácticos como estacionamiento gratuito, Wi-Fi en áreas comunes y asistencia turística, garantizando una experiencia sin complicaciones para sus huéspedes.</p>
            ...
            <h3>Servicios</h3>
            <p>• Piscina al aire libre <br> • Wi-Fi en áreas comunes <br> • Asistencia turística<br> • Transporte desde/hacia el aeropuerto</p>
            <h3>Niños</h3>
            <p>• Alojamiento familiar <br> • Camas adicionales disponibles bajo petición.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/j6KK7xJCJwg5dTE9A" class="btn">Ubicación</a>
