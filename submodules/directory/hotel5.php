...
<html lang="es">
   <head>
      ...
      <title>City Express Junior by Marriott Tijuana Otay | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/hotelexpre1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/hotelexpre2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>City Express Junior by Marriott Tijuana Otay</h3>
            <p>Ubicado en la zona de Otay, cerca del aeropuerto y de importantes centros comerciales y empresariales, City Express Junior by Marriott Tijuana Otay es una elección estratégica para los viajeros que desean moverse fácilmente por la ciudad. Sus habitaciones están diseñadas pensando en la funcionalidad y la comodidad, con características como camas cómodas, escritorio de trabajo y Wi-Fi gratuito. Además, el hotel ofrece un desayuno continental de cortesía, centro de negocios, servicio de transporte al aeropuerto y estacionamiento gratuito, asegurando una estancia sin contratiempos para sus huéspedes.</p>
            ...
            <p>• Instalaciones adaptadas para personas con movilidad reducida.<br> 
            • Estacionamiento accesible para personas en silla de ruedas</p>
            <h3>Actividades</h3>
            <p>• Centro de negocios<br> 
            • Cercanía a centros comerciales y de entretenimiento.</p>
            <h3>Servicios</h3>
            <p>• Desayuno continental de cortesía <br> • Servicio de transporte al aeropuerto <br> • Estacionamiento gratuito. <br>
            • Transporte desde/hacia el aeropuerto <br> • Servicio de lavandería</p>
            <h3>Niños</h3>
            <p>• Alojamiento familiar <br> • Libre de humo <br>
            • Políticas especiales para niños.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/8bze9ArS1t6wHs9Y7" class="btn">Ubicación</a>
