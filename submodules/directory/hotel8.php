...
<html lang="es">
   <head>
      ...
      <title>One Tijuana Otay | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/hotelone2.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/hotelone1.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>One Tijuana Otay</h3>
            <p>Convenientemente ubicado en la zona industrial de Otay, One Tijuana Otay ofrece un alojamiento moderno y funcional para viajeros que buscan comodidad y accesibilidad. Sus habitaciones están diseñadas con un estilo contemporáneo y cuentan con comodidades como televisores de pantalla plana, escritorios de trabajo y Wi-Fi gratuito. El hotel ofrece un desayuno continental de cortesía todas las mañanas, así como una variedad de servicios adicionales, incluyendo estacionamiento gratuito, gimnasio y centro de negocios. Su ubicación estratégica cerca del aeropuerto internacional y de importantes empresas y centros de convenciones lo convierten en una opción ideal para viajeros de negocios. Además, su atención personalizada y ambiente acogedor garantizan una estancia placentera para todos los huéspedes.</p>
            ...
            •  Instalaciones adaptadas para personas con movilidad reducida.</p>
            <h3>Actividades</h3>
            <p>• Desayuno continental de cortesía <br> 
            • Cercanía a centros de negocios.</p>
            <h3>Servicios</h3>
            <p>• Gimnasio <br> • Centro de negocios <br> • Estacionamiento gratuito. </p>
            <h3>Niños</h3>
      ...
      <a href="https://maps.app.goo.gl/x4vPR18LL1jPEsM87" class="btn">Ubicación</a>
