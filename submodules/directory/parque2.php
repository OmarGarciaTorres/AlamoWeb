      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/parqueguerrero2.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/parqueguerrero1.png) no-repeat"></div>
