...
<html lang="es">
   <head>
      ...
      <title>Plaza Paseo Chapultepec | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plazachapu1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plazachapu2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Plaza Paseo Chapultepec</h3>
            <p>Plaza Paseo Chapultepec es conocida por su ambiente elegante y moderno. Aquí, los visitantes pueden disfrutar de una amplia variedad de tiendas de moda y boutiques, así como de una selección de restaurantes y cafeterías para satisfacer todos los gustos. Con su diseño contemporáneo y su ambiente acogedor, es un lugar perfecto para pasar el día de compras y disfrutar de una deliciosa comida.</p>
            ...
            <p>• Diseño moderno y espacios accesibles para todos. <br> 
            • Estacionamiento accesible para personas en silla de ruedas</p>
            <h3>Actividades</h3>
            <p>• Compras <br> 
            • Cafeterías.</p>
            <h3>Servicios</h3>
            <p>• Estacionamiento <br> • Seguridad las 24 horas <br> • wifi gratuito. <br>
            • Presentaciones en vivo. <br> • Sanitario público <br> • Columpios</p>
            <h3>Niños</h3>
            <p> Área de juegos infantiles para el entretenimiento de los más pequeños. <br>
      ...
      <a href="https://maps.app.goo.gl/zrCoJJeAVQ88uEN59" class="btn">Ubicación</a>
