...
<html lang="es">
   <head>
      ...
      <title>Plaza Mundo Divertido | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="content">
            <h3>Plaza Mundo Divertido</h3>
            <p>Plaza Mundo Divertido es un destino único que combina la emoción de un parque de diversiones con la conveniencia de un centro comercial. Aquí, los visitantes pueden disfrutar de una amplia variedad de tiendas para ir de compras, desde boutiques hasta grandes cadenas comerciales. Además, el centro cuenta con una variedad de restaurantes que ofrecen una deliciosa comida para todos los gustos. Para el entretenimiento, Plaza Mundo Divertido ofrece emocionantes juegos mecánicos y atracciones para toda la familia.</p>
            ...
            <p>• Espacios accesibles para todos los visitantes. <br> 
            • Estacionamiento accesible para personas en silla de ruedas</p>
            <h3>Actividades</h3>
            <p>• Compras<br> 
            • Juegos mecánicos</p>
            <h3>Servicios</h3>
            <p>• Estacionamiento <br> • Seguridad <br> • Areas de descanso. <br> • Sanitario público </p>
            <h3>Niños</h3>
            <p>• Área de juegos infantiles y atracciones diseñadas específicamente para los más pequeños. 
            <br> • Es recomendable para cumpleaños infantiles <br>
      ...
      <a href="https://maps.app.goo.gl/Wgsb7FG867EJwgoj9" class="btn">Ubicación</a>
