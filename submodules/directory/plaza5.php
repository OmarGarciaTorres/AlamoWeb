...
<html lang="es">
   <head>
      ...
      <title>Plaza Carrousel | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plazacarr1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plazacarr2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Plaza Carrousel</h3>
            <p>Plaza Carrousel es un centro comercial que ofrece una experiencia de compras conveniente y cómoda para los residentes y visitantes de Tijuana. Aquí, los visitantes pueden encontrar una variedad de tiendas para satisfacer sus necesidades de compras, así como una variedad de restaurantes y cafeterías para disfrutar de una comida o una bebida rápida. La plaza también ofrece una gama de servicios, incluyendo bancos, farmacias y salones de belleza.</p>
            ...
            <h3>Niños</h3>
            <p>• Área de juegos <br>
            • Carrousel para niños <br> • Organización de eventos promocionales y ferias comerciales.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/TrgPa7yiGihdhAeU8" class="btn">Ubicación</a>
