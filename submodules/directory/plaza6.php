...
<html lang="es">
   <head>
      ...
      <title>Plaza Sendero | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plazasendero1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plazasendero2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Plaza Sendero</h3>
            <p>Plaza Sendero Tijuana es un destino popular que ofrece una amplia variedad de opciones para ir de compras, comer y divertirse. Aquí, los visitantes pueden encontrar tiendas de moda, electrónica, hogar y más, así como una variedad de restaurantes que sirven cocina local e internacional. Además, la plaza cuenta con una sala de cine, áreas de juegos para niños y eventos especiales que se llevan a cabo regularmente.</p>
            ...
            • Entretenimiento.</p>
            <h3>Servicios</h3>
            <p>• Estacionamiento <br> • Seguridad <br> • Cajeros automáticos.</p>
            <h3>Niños</h3>
            <p>• Área de juegos <br> • Actividades familiares. <br> • Juegos de arcade </p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/cVFEhgoUFVeJ9vrH9" class="btn">Ubicación</a>
