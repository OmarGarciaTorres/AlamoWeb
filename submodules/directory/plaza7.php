...
<html lang="es">
   <head>
      ...
      <title>Plaza Otay | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plazaotay1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plazaotay2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Plaza Otay</h3>
            <p>Plaza Otay es un centro comercial que ofrece una experiencia de compras conveniente y moderna en Tijuana. Aquí, los visitantes pueden encontrar una variedad de tiendas para satisfacer sus necesidades de compras, desde moda hasta electrónica y artículos para el hogar. Además, la plaza cuenta con una selección de restaurantes y cafeterías para disfrutar de una comida o una bebida rápida. También ofrece una gama de servicios, como bancos, farmacias y salones de belleza.</p>
            ...
            • Restaurantes </p>
            <h3>Servicios</h3>
            <p>• Seguridad 24/7 <br> • Estacionamiento <br> • Servicios bancarios y de salud. </p>
            <h3>Niños</h3>
            <p>• Área de juegos infantiles  <br> • Actividades familiares. <br>
            • Organización de eventos promocionales y exhibiciones temáticas.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/DviG6hE1ogXX6g7i7" class="btn">Ubicación</a>
