      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plazamonarca1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plazamonarca2.png) no-repeat"></div>
