...
<html lang="es">
   <head>
      ...
      <title>Plaza 2000 | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/plaza20001.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/plaza20002.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Plaza 2000</h3>
            <p>Plaza 2000 es un destino popular para ir de compras, comer y divertirse en Tijuana. Aquí, los visitantes pueden encontrar una amplia variedad de tiendas para satisfacer sus necesidades de compras, desde moda hasta tecnología y artículos para el hogar. Además, la plaza cuenta con una selección de restaurantes y cafeterías para disfrutar de una comida o una bebida rápida. También ofrece una gama de servicios, como bancos, farmacias y salones de belleza.</p>
            ...
            <p>• Diseño accesible para personas de todas las edades y habilidades. <br> 
            • Estacionamiento accesible para personas en silla de ruedas</p>
            <h3>Actividades</h3>
            <p>• Compras <br> 
            • Restaurantes </p>
            <h3>Servicios</h3>
            <p>• Estacionamiento <br> • Servicios bancarios y de salud. <br> • Area de comida</p>
            <h3>Niños</h3>
            <p>• Área de juegos <br>• Ideal para ir con niños <br> • Celebración de eventos promocionales y ferias comerciales.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/6zno5MCnFn1nMKu47" class="btn">Ubicación</a>
