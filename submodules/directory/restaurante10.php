...
<html lang="es">
   <head>
      ...
      <title>El Taller | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/restataller1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/restataller2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>El Taller</h3>
            <p>El Taller es un destino culinario popular en Tijuana, conocido por su innovadora fusión de sabores mexicanos e internacionales. Ubicado en un espacio moderno y elegante, este restaurante ofrece un ambiente acogedor y contemporáneo que invita a los comensales a relajarse y disfrutar de una comida deliciosa. El menú de El Taller presenta una amplia variedad de platillos, desde tacos gourmet hasta ensaladas frescas y platos de pasta creativos. Cada plato está cuidadosamente elaborado con ingredientes frescos y de la más alta calidad, resaltando los sabores y texturas únicos de cada ingrediente.</p>
            ...
            <p>•  El restaurante es accesible para todos los comensales, con un diseño moderno y espacios amplios entre mesas.</p>
            <h3>Actividades</h3>
            <p>• Los comensales pueden disfrutar de música en vivo en ciertas noches y eventos especiales como cenas maridaje.</p>
            <h3>Servicios</h3>
            <p>• Asientos en la terraza <br> • Platos orgánicos <br> • Platos vegetarianos <br>
            • Vino <br> • Cócteles <br> • Aperitivos</p>
            <h3>Niños</h3>
            <p>• Aunque no hay un menú específico para niños, los platos más suaves y sabores familiares son adecuados para los más pequeños.</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/FKktUYQCEjdiytt66" class="btn">Ubicación</a>
