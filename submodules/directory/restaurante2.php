...
<html lang="es">
   <head>
      ...
      <title>Telefónica Gastro Park | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/restatelefonica1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/restatelefonica2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Telefónica Gastro Park</h3>
            <p>Telefónica Gastro Park es un concepto innovador que reúne a algunos de los mejores chefs y cocineros callejeros de la región en un solo lugar. Ubicado en un antiguo almacén renovado, este parque gastronómico ofrece un ambiente urbano y moderno, perfecto para los amantes de la comida que buscan nuevas experiencias culinarias. Los visitantes pueden explorar una variedad de puestos de comida que sirven desde tacos y hamburguesas gourmet hasta platos internacionales y postres artesanales. Además de la comida, el parque cuenta con áreas de estar al aire libre, música en vivo y eventos temáticos que añaden un toque extra de emoción a la experiencia gastronómica.</p>
            ...
            <h3>Actividades</h3>
            <p>• Música en vivo y proyecciones de películas al aire libre <br> 
            • Eventos especiales como ferias de comida y festivales de cocina.</p>
            <h3>Servicios</h3>
            <p>• Estacionamiento <br> • Personal de seguridad  <br> • Servicio de catering <br>
            • Bebidas en hora feliz <br> • Platos vegetarianos <br> • Comidas durante la madrugada</p>
            <h3>Niños</h3>
            <p>• Sillas altas <br> • Menú para niños <br> • Ideal para ir con niños </p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/R5q1vbszSNdruWtT6" class="btn">Ubicación</a>
