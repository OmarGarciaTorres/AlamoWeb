...
<html lang="es">
   <head>
      ...
      <title>Mision 19 | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/restamision191.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/restamision192.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Mision 19</h3>
            <p>Misión 19 es una joya culinaria en Tijuana, dirigida por el reconocido chef Javier Plascencia. Ubicado en el piso 19 de un moderno edificio en Zona Río, este restaurante ofrece vistas impresionantes de la ciudad y una experiencia gastronómica única. El menú de Misión 19 destaca los sabores frescos y auténticos de Baja California, utilizando ingredientes locales y técnicas de cocina modernas para crear platos innovadores y deliciosos. El ambiente del restaurante es sofisticado y acogedor, con un servicio impecable y una atención meticulosa a los detalles.</p>
            ...
            <h3>Actividades</h3>
            <p>• Cenas especiales <br> 
            • Eventos de maridaje de vinos</p>
            <h3>Servicios</h3>
            <p>• Estacionamiento con valet parking <br> • Sommelier para asesorar en la selección de vinos. <br> • Comidas durante la madrugada <br>
            • Platos vegetarianos <br> • Barra de ensaladas <br> • Bebidas fuertes </p>
            <h3>Niños</h3>
            <p>• Aunque el restaurante no tiene un menú específico para niños, el personal está dispuesto a adaptar los platos según las preferencias de los más pequeños. </p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/vw5VacTfpvrMsK3G7" class="btn">Ubicación</a>
