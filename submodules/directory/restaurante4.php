...
<html lang="es">
   <head>
      ...
      <title>Café La Especial | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/restaespecial1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/restaespecial2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Café La Especial</h3>
            <p>Café La Especial es un punto de encuentro popular en Tijuana, especialmente durante las mañanas. El restaurante se destaca por su ambiente acogedor y su servicio amigable, que hacen que los clientes se sientan como en casa desde el momento en que entran por la puerta. El menú ofrece una variedad de platillos mexicanos tradicionales, desde chilaquiles hasta huevos rancheros, así como una selección de opciones americanas para aquellos que prefieren un desayuno más familiar. Además, Café La Especial es conocido por su café de calidad, que se sirve fresco y caliente durante todo el día.</p>
            ...
            • El restaurante es accesible para todos los clientes, con rampas y espacios amplios entre mesas.</p>
            <h3>Actividades</h3>
            <p>• Cocteleria <br> 
            • Música en vivo</p>
            <h3>Servicios</h3>
            <p>• Wi-Fi gratis <br> • Se aceptan reservas <br> • Estacionamiento gratuito <br>
            • Desayuno-almuerzo <br> • Postres <br> • Para llevar</p>
            <h3>Niños</h3>
            <p>• Ideal para ir con niños <br> • Menú para niños <br>
            • Sillas altas</p>
         </div>
      </section>
      ...
      <a href="https://maps.app.goo.gl/D6LrUc4VVKKNzue9A" class="btn">Ubicación</a>
