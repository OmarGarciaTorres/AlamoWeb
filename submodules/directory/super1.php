...
<html lang="es">
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/walmart1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/walmart2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Walmart</h3>
            <p>Walmart es una cadena de supermercados internacional que ofrece una amplia variedad de productos alimenticios, artículos para el hogar, productos electrónicos y más, a precios competitivos. Con múltiples ubicaciones en Tijuana, Walmart es conocido por su amplia selección de productos y su compromiso con la calidad y el servicio al cliente.</p>
      ...
      <a href="https://maps.app.goo.gl/yjcZSXqM59A73pG66" class="btn">Ubicación mas famosa</a>
