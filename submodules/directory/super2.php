...
<html lang="es">
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/soriana1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/soriana2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Soriana</h3>
            <p>Soriana es una cadena de supermercados que ofrece una amplia selección de productos alimenticios, artículos para el hogar y otros productos de consumo, con un enfoque en la calidad y el servicio al cliente. Con tiendas convenientemente ubicadas en toda la ciudad, Soriana es una opción popular para las compras diarias en Tijuana.</p>
      ...
      <a href="https://maps.app.goo.gl/LzJFahcVfQg3kBd68" class="btn">Ubicación mas famosa</a>
