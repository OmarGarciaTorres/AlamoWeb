...
<html lang="es">
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/calimax1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/calimax2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Calimax</h3>
            <p>Calimax es una cadena de supermercados regional que ofrece una amplia variedad de productos alimenticios frescos y envasados, así como otros productos de consumo, con un enfoque en la calidad y la frescura. Con una reputación establecida por su compromiso con la calidad, Calimax es una opción confiable para las compras en Tijuana.</p>
      ...
      <a href="https://maps.app.goo.gl/DaAsEJyaCTurDvjq7" class="btn">Ubicación mas famosa</a>
