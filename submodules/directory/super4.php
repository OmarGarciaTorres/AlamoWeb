...
<html lang="es">
   <head>
      ...
      <title>Ley Supermercados | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/ley1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/ley2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Ley Supermercados</h3>
            <p>Ley Supermercados es una cadena de supermercados que ofrece una amplia selección de productos alimenticios, artículos para el hogar, productos electrónicos y más, con un enfoque en la calidad y el servicio al cliente. Con tiendas bien surtidas y un servicio excepcional, Ley Supermercados es una opción popular para las compras en Tijuana.</p>
      ...
      <a href="https://maps.app.goo.gl/f5wLJ9Fk832zGyY1A" class="btn">Ubicación mas famosa</a>
