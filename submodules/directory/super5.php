...
<html lang="es">
   <head>
      ...
      <title>Comercial Mexicana | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/comercial1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/comercial2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Comercial Mexicana</h3>
            <p>Comercial Mexicana es una cadena de supermercados que ofrece una amplia variedad de productos alimenticios, productos para el hogar, ropa y más, con un enfoque en la calidad y la variedad. Con una amplia selección de productos y precios competitivos, Comercial Mexicana es una opción conveniente para las compras en Tijuana.</p>
      ...
      <a href="https://maps.app.goo.gl/bbBJSGCgLueY3BXd8" class="btn">Ubicación</a>
