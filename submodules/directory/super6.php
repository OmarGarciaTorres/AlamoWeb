...
<html lang="es">
   <head>
      ...
      <title>Ley Express | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/leyexpress1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/leyexpress2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Ley Express</h3>
            <p>Ley Express es una tienda de conveniencia que ofrece una selección de productos básicos, como bebidas, snacks, alimentos preparados y artículos de uso diario, con un enfoque en la comodidad y la rapidez. Con ubicaciones convenientemente ubicadas en toda la ciudad, Ley Express es perfecto para compras rápidas y convenientes en Tijuana.</p>
      ...
      <a href="https://maps.app.goo.gl/193YWgtKwnnK5djz8" class="btn">Ubicación mas famosa</a>
