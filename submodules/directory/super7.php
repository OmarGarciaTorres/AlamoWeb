...
<html lang="es">
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/oxxo1.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>OXXO</h3>
            <p>OXXO es una cadena de tiendas de conveniencia que ofrece una selección de productos básicos, como bebidas, snacks, alimentos preparados y artículos de cuidado personal, con un enfoque en la comodidad y la accesibilidad. Con tiendas en cada esquina, OXXO es un destino conveniente para las compras diarias en Tijuana.</p>
      ...
      <a href="https://www.google.com/maps/search/OXXO/@32.5217742,-116.9475017,15z/data=!3m1!4b1?entry=ttu" class="btn">Ubicación</a>
