...
<html lang="es">
   <head>
      ...
      <title>Bodega Aurrerá | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/bodega1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/bodega2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Bodega Aurrerá</h3>
            <p>Bodega Aurrerá es una cadena de supermercados que ofrece una amplia gama de productos a precios accesibles, con un enfoque en la calidad y la economía. Con una variedad de productos y ofertas especiales, Bodega Aurrerá es una opción popular para las compras en Tijuana.</p>
      ...
      <a href="https://www.google.com/maps/search/Bodega+Aurrera/@32.5218575,-116.9784018,13z/data=!3m1!4b1?entry=ttu" class="btn">Ubicación</a>
