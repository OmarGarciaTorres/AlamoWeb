...
<html lang="es">
   <head>
      ...
      <title>Supermercados El Florido | Alamo Web</title>
   ...
   <body>
      ...
      <section class="home">
         ...
         <div class="swiper home-slider">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide slide" style="background:url(/images/florido1.png) no-repeat"></div>
               <div class="swiper-slide slide" style="background:url(/images/florido2.png) no-repeat"></div>
         ...
         <div class="content">
            <h3>Supermercados El Florido</h3>
            <p>Supermercados El Florido es una cadena de supermercados regional que ofrece una variedad de productos alimenticios, productos para el hogar y más, con un enfoque en la calidad y la satisfacción del cliente. Con múltiples ubicaciones en Tijuana, Supermercados El Florido ofrece una experiencia de compra conveniente y satisfactoria para los residentes y visitantes de la ciudad.</p>
      ...
      <a href="https://www.google.com/maps/search/El+Florido/@32.5219888,-116.9784018,13z/data=!3m1!4b1?entry=ttu" class="btn">Ubicación</a>
